...
> **源码卷对位阅读**：本章（T6）对应源码卷 [第 4 章 Tool / 权限 / 沙箱（MCP 部分）](../ch04-tools.md) 与 [第 8 章 模型抽象与多 Provider](../ch07-model.md)——本章讲框架/向量/标准生态，源码卷讲 MCP/Skill 与多 provider 抽象。
...
> **回到源码卷**：[第 4 章 Tool / 权限 / 沙箱](../ch04-tools.md) / [第 8 章 模型抽象与多 Provider](../ch07-model.md) 给出 MCP/Skill 与多 provider 抽象的源码对证。
