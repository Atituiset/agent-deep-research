...
> **源码卷对位阅读**：本章（T1）对应源码卷 [第 1 章 全景与定位](../ch01-landscape.md) 与 [第 2 章 公共模型：六件套](../ch02-common-model.md)——前者给六组件模型与五约束，后者给六件套心智模型与 200 行闭环。
...
> **回到源码卷**：[第 1 章 全景与定位](../ch01-landscape.md) / [第 2 章 公共模型：六件套](../ch02-common-model.md) 给出九家实现的行号级对证。
